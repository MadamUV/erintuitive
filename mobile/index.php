	...
	<script>
		...
		function checkSpiral() {
			...
			if(document.getElementById("spiral2").checked == true){
				track.innerHTML = '<li class="glide__slide"><img  width="280" height="280" src="../svg/spiral1.svg" alt="first spiral"></li><li class="glide__slide"><img  width="280" height="280" src="../svg/spiral2.svg" alt="second spiral"></li><li class="glide__slide"><img  width="280" height="280" src="../svg/spiral3.svg" alt="third spiral"></li><li class="glide__slide"><img  width="280" height="280" src="../svg/spiral4.svg" alt="fourth spiral"></li><br><li class="glide__slide"><img  width="280" height="280" src="../svg/spiral5.svg" alt="fifth spiral"></li><li class="glide__slide"><img  width="280" height="280" src="../svg/spiral6.svg" alt="sixth spiral"></li><li class="glide__slide"><img  width="280" height="280" src="../svg/spiral7.svg" alt="seventh spiral"></li><li class="glide__slide"><img  width="280" height="280" src="../svg/spiral8.svg" alt="eighth spiral"></li><br><li class="glide__slide"><img  width="280" height="280" src="../svg/spiralSun.svg" alt="ninth spiral"></li>';
				slider = $("#result").glide({
					type: "carousel"
				});
				transferData();
