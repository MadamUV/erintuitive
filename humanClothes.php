...
<body style="background-color: #FFBB22;">
	...
	function nextOptions() {
		if(avatarOptions.getAttribute("class")=="tops"){
			...
			if ($(".woman")[0]){
				$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt'+(num+1).toString()+'_stickers/female_shirt'+(num+1).toString()+'_sticker1.svg">');
