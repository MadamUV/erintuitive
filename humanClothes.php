...
<body style="background-color: #FFBB22;">
	...
	function postAvatarWithName(){
		...
		var sprite = '<div id="sprite" style="-ms-transform: scale(0.4); -webkit-transform: scale(0.4); transform: scale(0.4);"><div class="blinking" style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'<br><span style="-ms-transform: scale(1, 1); -webkit-transform: scale(1, 1); transform: scale(1, 1);"><img style="position: absolute; top: 38px; left: -40px; z-index: 202;" width="200%" src="svg/human/humanBody/cloud.svg"/><span style="position: absolute; top: 397px; z-index: 204; -webkit-transform: scale(2); -ms-transform: scale(2); transform: scale(2);">'+name+'</span></span></div><div style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'<br><span style="-ms-transform: scale(1, 1); -webkit-transform: scale(1, 1); transform: scale(1, 1);"><img style="position: absolute; top: 38px; left: -40px; z-index: 202;" width="200%" src="svg/human/humanBody/cloud.svg"/><span style="position: absolute; top: 397px; z-index: 204; -webkit-transform: scale(2); -ms-transform: scale(2); transform: scale(2);">'+name+'</span></span></div><div style="position: relative; float: left; margin: 90px;">'+avatar+'<br><img style="position: absolute; top: 38px; left: -40px; z-index: 202;" width="200%" src="svg/human/humanBody/cloud.svg"/><span style="position: absolute; top: 397px; z-index: 204; -webkit-transform: scale(2); -ms-transform: scale(2); transform: scale(2);">'+name+'</span></div><div class="blinking" style="position: relative; float: left; margin: 90px;">'+avatar+'<br><img style="position: absolute; top: 38px; left: -40px; z-index: 202;" width="200%" src="svg/human/humanBody/cloud.svg"/><span style="position: absolute; top: 397px; z-index: 204; -webkit-transform: scale(2); -ms-transform: scale(2); transform: scale(2);">'+name+'</span></div></div>';
		$(".pets").css({'-ms-transform': 'scale(1, 1)', '-webkit-transform': 'scale(1, 1)', 'transform': 'scale(1, 1)'});
	...
	function pet(){
		var pets = [''];
		for(i=1; i<=18; i++){
			pets.push('<img class="pets" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/pets/pet'+i.toString()+'.svg" alt="pet">');
		}
		if($(".woman")[0]){
			pets.push('<img class="pets" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/pets/female_pet19.svg" alt="pet">');
		}
		else if($(".woman")[0]){
			pets.push('<img class="pets" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/pets/pet19.svg" alt="pet">');
		}
		return shuffle(pets);
	}
	function cape(){
		var capes = [''];
		for(i=1; i<=4; i++){
			capes.push('<img class="capes" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/capes/cape'+i.toString()+'.svg" alt="cape">')
		}
	...
	function necklace(){
		var necklaces = [''];
		for(i=1; i<=6; i++){
			necklaces.push('<img class="necklaces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/necklaces/necklace'+i.toString()+'.svg" alt="necklace">');
		}
	...
	function glasses(){
		var glasses = [''];
		for(i=1; i<=6; i++){
			glasses.push('<img class="glasses" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/glasses/glasses'+i.toString()+'.svg" alt="glasses">');
		}
	...
	function accessories(){
		var accessories = [''];
		for(i=1; i<=8; i++){
			accessories.push('<img class="accessories" id="accessory'+i.toString()+'" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/accessories/accessory'+i.toString()+'.svg" alt="accessories">');
		}
	...
	function wings(){
		var wings = [''];
		for(i=1; i<=12; i++){
			wings.push('<img class="wings" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/wings/wings'+i.toString()+'.svg" alt="wings">');
		}
	...
	function maleShoes(){
		var maleShoes = [];
		for (i=1; i<=13; i++){
			maleShoes.push('<img class="shoes" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/shoes/shoes'+i.toString()+'.svg" alt="shoes">');
		}
		maleShoes.push('');
	...
	function femaleShoes(){
		var femaleShoes = [];
		for (i=1; i<=16; i++){
			femaleShoes.push('<img class="shoes" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_shoes/female_shoes'+i.toString()+'.svg" alt="shoes">');
		}
		femaleShoes.push('');
		return shuffle(femaleShoes);
	}
	function maleHairPieces(){
		var maleHairPieces = ['', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/male_hairPieces/neutralHairPiece1.svg" style="position: absolute; z-index: 41; top: -40px; left: 0;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/male_hairPieces/neutralHairPiece2.svg" style="position: absolute; z-index: 41; top: -30px; left: 0;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/male_hairPieces/neutralHairPiece3.svg" style="position: absolute; z-index: 41; top: -78px; left: 0;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/male_hairPieces/neutralHairPiece4.svg" style="position: absolute; z-index: 41; top: -40px; left: -7px;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/male_hairPieces/neutralHairPiece5.svg" style="position: absolute; z-index: 41; top: -15px; left: 0;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/male_hairPieces/neutralHairPiece6.svg" style="position: absolute; z-index: 41; top: -60px; left: 2px;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/male_hairPieces/neutralHairPiece7.svg" style="position: absolute; z-index: 41; top: -67px; left: -9px;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/male_hairPieces/neutralHairPiece8.svg" style="position: absolute; z-index: 41; top: -30px; left: 0;"/>', /*only male hairpieces*/ '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/male_hairPieces/maleHairPiece1.svg" style="position: absolute; z-index: 41; top: -30px; left: 0;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/male_hairPieces/maleHairPiece2.svg" style="position: absolute; z-index: 41; top: -18px; left: 0;"/>'];
		return shuffle(maleHairPieces);
	}
	function femaleHairPieces(){
		var femaleHairPieces = ['', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_hairPieces/female_hairPiece1.svg" style="position: absolute; z-index: 41; top: -14px; left: 0;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_hairPieces/female_hairPiece2.svg" style="position: absolute; z-index: 41; top: -14px; left: 0;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_hairPieces/female_hairPiece3.svg" style="position: absolute; z-index: 41; top: 15px; left: 0px; -ms-transform: scale(1.18, 1.3); -webkit-transform: scale(1.18, 1.3); transform: scale(1.18, 1.3);"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_hairPieces/female_hairPiece6.svg" style="position: absolute; z-index: 41; top: -27px; left: -22px;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_hairPieces/neutralHairPiece1.svg" style="position: absolute; z-index: 41; top: -40px; left: 0;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_hairPieces/neutralHairPiece2.svg" style="position: absolute; z-index: 41; top: -27px; left: 0;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_hairPieces/neutralHairPiece3.svg" style="position: absolute; z-index: 41; top: -78px; left: 0;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_hairPieces/neutralHairPiece4.svg" style="position: absolute; z-index: 41; top: -37px; left: -7px;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_hairPieces/neutralHairPiece5.svg" style="position: absolute; z-index: 41; top: -15px; left: 0;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_hairPieces/neutralHairPiece6.svg" style="position: absolute; z-index: 41; top: -60px; left: 2px;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_hairPieces/neutralHairPiece7.svg" style="position: absolute; z-index: 41; top: -67px; left: -9px;"/>', '<img class="hairPieces" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_hairPieces/neutralHairPiece8.svg" style="position: absolute; z-index: 41; top: -27px; left: 0;"/>'];
	...
	function maleTopOverlays(){
		...
		for (k=0; k<13; k++){
			for (i=1; i<=numbers[k]; i++){
				maleTops.push(maleTops[k]+'<img class="shirtOverlay" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/shirt'+(k+1).toString()+'_stickers/shirt'+(k+1).toString()+'_sticker'+i.toString()+'.svg">');
			}
		}
		maleTops.push('');
	...
	function maleBottomOverlays(){
		...
		for (k=0; k<3; k++){
			for (i=1; i<=numbers[k]; i++){
				maleBottoms.push(maleBottoms[k]+'<img class="bottomOverlay" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/pants'+(k+1).toString()+'_stickers/pants'+(k+1).toString()+'_sticker'+i.toString()+'.svg">');
			}
		}
		...
		for (k=0; k<2; k++){
			for (i=1; i<=numbers[k]; i++){
				maleBottoms.push(maleBottom[k]+'<img class="bottomOverlay" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/skirt'+(k+1).toString()+'_stickers/skirt'+(k+1).toString()+'_sticker'+i.toString()+'.svg">');
			}
		}
		maleBottoms.push('');
	...
	function femaleBottomOverlays(){
		...
		for (k=0; k<5; k++){
			for (i=1; i<=numbers[k]; i++){
				femaleBottoms.push(femaleBottoms[k]+'<img class="bottomOverlay" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_pants'+(k+1).toString()+'_stickers/female_pants'+(k+1).toString()+'_sticker'+i.toString()+'.svg">');
			}
		}
		...
		for (k=0; k<2; k++){
			for (i=1; i<=numbers[k]; i++){
				femaleBottoms.push(femaleBottom[k]+'<img class="bottomOverlay" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_skirt'+(k+1).toString()+'_stickers/female_skirt'+(k+1).toString()+'_sticker'+i.toString()+'.svg">');
			}
		}
		femaleBottoms.push('');
	...
	function femaleTopOverlays(){
		...
		for (k=0; k<16; k++){
			for (i=1; i<=numbers[k]; i++){
				femaleTops.push(femaleTops[k]+'<img class="shirtOverlay" src="https://erintuitive.herokuapp.com/svg/human/humanClothes/female_shirt'+(k+1).toString()+'_stickers/female_shirt'+(k+1).toString()+'_sticker'+i.toString()+'.svg">');
			}
		}
		femaleTops.push('');
