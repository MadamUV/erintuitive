...
<body style="background-color: #FFBB22;">
	...
	function postAvatarWithName(){
		...
		var sprite = '<table id="sprite" style="-ms-transform: scale(0.4); -webkit-transform: scale(0.4); transform: scale(0.4);"><tr><td><div> style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</div></td><td><div style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</div></td><td><div style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</div></td><td><div class="blinking" style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</div></td></tr><tr><td><div style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</div></td><td><div style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</div></td><td><div style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</div></td><td><div class="blinking" style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</div></td></tr><tr><td><div style="position: relative; float: left; margin: 90px;">'+avatar+'</div></td><td><div style="position: relative; float: left; margin: 90px; ">'+avatar+'</td><td style="position: relative; float: left; margin: 90px;">'+avatar+'</div></td><td><div class="blinking" style="position: relative; float: left; margin: 90px;">'+avatar+'</div></td></tr><tr><td><div style="position: relative; float: left; margin: 90px;">'+avatar+'</td><td style="position: relative; float: left; margin: 90px; ">'+avatar+'</div></td><td><div style="position: relative; float: left; margin: 90px;">'+avatar+'</td><td class="blinking" style="position: relative; float: left; margin: 90px;">'+avatar+'</div></td></tr></table>';
