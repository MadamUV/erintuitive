...
<body style="background-color: #FFBB22;">
	...
	<iframe id="youtubeVids" style="position: fixed; top: 20px; left: 100px;" width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLSsWZPHpbaIMwdcbi9ezl10wdeAKrog2P?controls=0" frameborder="0" allowfullscreen></iframe>
	...
	function postAvatarWithName(){
		...
		for (var i=0; i<imgs.length; i++){
			...
			element.innerHTML = element.innerHTML + '<svg xmlns="http://www.w3.org/2000/svg" style="'+myStyle+'" width="'+myStyle.width+'" height="'+myStyle.height+'"><image href="'+mySrc+'" width="'+myStyle.width+'" height="'+myStyle.height+'"></svg>';
		}
