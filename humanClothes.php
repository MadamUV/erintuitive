...
<body style="background-color: #FFBB22;">
	...
	function postAvatarWithName(){
		...
		var sprite = '<table id="sprite" style="-ms-transform: scale(0.4); -webkit-transform: scale(0.4); transform: scale(0.4);"><tr><td style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</td><td style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</td><td style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</td><td class="blinking" style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</td></tr><tr><td style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</td><td style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</td><td style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</td><td class="blinking" style="position: relative; float: left; margin: 90px; -ms-transform: scale(-1, 1); -webkit-transform: scale(-1, 1); transform: scale(-1, 1);">'+avatar+'</td></tr><tr><td style="position: relative; float: left; margin: 90px;">'+avatar+'</td><td style="position: relative; float: left; margin: 90px; ">'+avatar+'</td><td style="position: relative; float: left; margin: 90px;">'+avatar+'</td><td class="blinking" style="position: relative; float: left; margin: 90px;">'+avatar+'</td></tr><tr><td style="position: relative; float: left; margin: 90px;">'+avatar+'</td><td style="position: relative; float: left; margin: 90px; ">'+avatar+'</td><td style="position: relative; float: left; margin: 90px;">'+avatar+'</td><td class="blinking" style="position: relative; float: left; margin: 90px;">'+avatar+'</td></tr></table>';
