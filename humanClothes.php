...
<body style="background-color: #FFBB22;">
	...
	function backOptions() {
		if(avatarOptions.getAttribute("class")=="bottoms1"){
	...
	function nextOptions() {
		if(avatarOptions.getAttribute("class")=="tops"){
			...
			if ($(".woman")[0]){
				$("#relativeContainer").append('<div id="female_shirts"><img class="shirtOverlay" src="svg/human/humanClothes/female_shirt'+(num+1).toString()+'_stickers/female_shirt'+(num+1).toString()+'_sticker'+female_top.toString()+'.svg"></div>');
	...
	function nextTopOverlay() {
		...
		if($(".shirt1")[0]){
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt2_stickers/female_shirt2_sticker'+female_top.toString()+'.svg">'); 
			female_top++;
			if(female_top==16){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt3_stickers/female_shirt3_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==27){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt4_stickers/female_shirt4_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==24){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt5_stickers/female_shirt5_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==13){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt6_stickers/female_shirt6_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==20){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt7_stickers/female_shirt7_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==25){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt8_stickers/female_shirt8_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==22){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt9_stickers/female_shirt9_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==20){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt10_stickers/female_shirt10_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==20){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt11_stickers/female_shirt11_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==15){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt12_stickers/female_shirt12_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==15){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt13_stickers/female_shirt13_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==15){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt14_stickers/female_shirt14_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==15){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt15_stickers/female_shirt15_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==14){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt16_stickers/female_shirt16_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==3){
				female_top = 1;
			}
