...
<body style="background-color: #FFBB22;">
	...
	function randomizeCapes() {
		...
		$("#relativeContainer .capes").css({'position':'absolute', 'top':'0', 'left':'95px', 'margin-top':'0', 'z-index':'-42', '-webkit-transform':'scale(2.1)', '-ms-transform':'scale(2.1)', 'transform':'scale(2.1)'});
	}
