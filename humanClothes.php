...
<body style="background-color: #FFBB22;">
	...
	function randomizeShoes() {
		if($(".man")[0]){
			...
			if($(".shoes")[0].getAttribute("src")=="svg/human/humanClothes/shoes/shoes11.svg" || $(".shoes").getAttribute("src")=="svg/human/humanClothes/shoes/shoes12.svg" || $(".shoes").getAttribute("src")=="svg/human/humanClothes/shoes/shoes13.svg"){
