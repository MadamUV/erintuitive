...
<body style="background-color: #FFBB22;">
	...
	function nextTopOverlay() {
		...
		if(num==1){
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt'+num.toString()+'_stickers/female_shirt'+(num+1).toString()+'_sticker'+female_top.toString()+'.svg">'); 
			female_top++;
			if(female_top==16){
				female_top = 1;
			}
			...
			$("#relativeContainer").append('<img class="shirtOverlay" src="svg/human/humanClothes/female_shirt'+(num+1).toString()+'_stickers/female_shirt'+num.toString()+'_sticker'+female_top.toString()+'.svg">');
			female_top++;
			if(female_top==27){
				female_top = 1;
			}
